...
function ProblemSection() {
    ...
    return (
        <div className="p-3 overflow-auto bg-gray-700 border-y border-r border-gray-600">
            <section className="flex flex-col gap-2 h-[400px]">
                <section className="flex-1 flex flex-col">
                    ...
                    <div className="w-full h-[390px] resize-none bg-gray-700 text-white overflow-auto p-2">
                        ...
                        English. Many desktop publiearch for 'lorem ipsum' will
                        uncover many web sites still in their infancy. Various
                        versions have evolved over the years, sometimes by
                        accident, sometimes on purpose (injected humour and the
                        like). Where does it come from? Contrary Extremes of
                        Good and Evil) by Cicero, written in 45 BC. This book is
                        a treatise on the theory of ethics, very popular during
